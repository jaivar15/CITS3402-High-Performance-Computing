...
/*
    ...
    Description: Simulate Conway's Game of Life using the parallel threading capabilities of OpenMP
...
//Global Variables
int** array;        //generates the 2D board with 1's and 0's
int** newarray;     //stores the next evolution of the 2D board
int threadCount;    //user input threadcount
int array2DSize;    //2D Matrix Size
/*------------------------------------THE MAIN FUNCTIONs----------------------------------------------------*/

int main(int argc, char* argv[])
{
    //user-input the size of the array
    array2DSize = atoi(argv[1]);
...
/*
 Writes the 1's and 0's generated board into a text file.
